...
public class JdbcTemplateItemRepositoryV2 implements ItemRepository {
    ...
    public Item save(Item item) {
        ...
        BeanPropertySqlParameterSource param = new BeanPropertySqlParameterSource(item); // item의 필드통해 파라미터만듬.
    ...
    public void update(Long itemId, ItemUpdateDto updateParam) {
        String sql = "update item set item_name = :item_name, price=:price, quantity=:quantity where_id=:id";
    ...
    public Optional<Item> findById(Long id) {
        ...
        try {
            ...
            Item item = template.queryForObject(sql, param, getItemRowMapper());
    ...
    public List<Item> findAll(ItemSearchCond cond) {
        ...
        return template.query(sql, param, getItemRowMapper());
    }
    ...
    private RowMapper<Item> getItemRowMapper() {
        return BeanPropertyRowMapper.newInstance(Item.class); // spring이 제공.(camel을 지원)
    }
}
